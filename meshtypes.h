...
class CEdge;
struct MyUsedTypes
    : public UsedTypes<Use<CVertex>::AsVertexType, Use<CEdge>::AsEdgeType,
...
class CVertex : public vcg::Vertex<MyUsedTypes, vcg::vertex::Coord3f,
                                   ...
                                   vcg::vertex::Color4b, vertex::TexCoord2f,
                                   vcg::vertex::BitFlags, vcg::vertex::VEAdj,
                                   vertex::Qualityf, vertex::Mark> {};
class CEdge : public Edge<MyUsedTypes, edge::VertexRef, edge::BitFlags,
                          edge::EEAdj, edge::EFAdj, edge::VEAdj> {};
class CFace
    : public vcg::Face<MyUsedTypes, vcg::face::VertexRef, vcg::face::FFAdj,
                       vcg::face::VFAdj, vcg::face::Normal3f,
                       vcg::face::EdgePlane, vcg::face::Color4b,
                       vcg::face::BitFlags, face::Mark, face::WedgeTexCoord2f> {
};
...
class PVertex : public vcg::Vertex<PUsedTypes, vcg::vertex::Coord3f,
                                   vcg::vertex::Normal3f, vcg::vertex::Mark,
                                   vcg::vertex::BitFlags, vcg::vertex::VHAdj,
                                   vcg::vertex::Qualityf, vcg::vertex::VFAdj> {
};
...
class PHEdge
    : public HEdge<PUsedTypes, hedge::BitFlags,
                   ...
                   hedge::HEdgeData // the previous 4 components (just more
                                    // handy, you can comment this and uncomment
...
class PFace
    : public vcg::Face<
          ...
          ,
          vcg::face::PFHAdj // Pointer its half -edges  ( you may need this if
                            // you use half edges)
          ,
          ...
          ,
          vcg::face::Color4b, vcg::face::Qualityf, vcg::face::WedgeTexCoord2f,
          vcg::face::Mark, vcg::face::EdgePlane> {};

class PMesh
    : public vcg::tri::TriMesh<
          std::vector<PVertex>, // the vector of vertices
          std::vector<PFace>,   // the vector of faces
          // std::vector<PHEdge>		,						// the vector of
          // edges
